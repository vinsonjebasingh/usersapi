...
class UsersSerializer(serializers.ModelSerializer):
    ...
    id            = serializers.IntegerField(max_value=9223372036854775807, min_value=0,required=False, validators=[UniqueValidator(queryset=Users.objects.all())])
...
class OrdersSerializer(serializers.ModelSerializer):
    ...
    id            = serializers.IntegerField(max_value=9223372036854775807, min_value=0,required=False, validators=[UniqueValidator(queryset=Orders.objects.all())])
    user_id       = serializers.IntegerField(max_value=9223372036854775807, min_value=0,required=True)
    product_id    = serializers.IntegerField(max_value=9223372036854775807, min_value=0,required=True)
    ...
    created_date  = serializers.DateTimeField(required=False)
    status        = serializers.IntegerField(max_value=2147483647, min_value=0, required=False)
...
#     user_details =  OrdersSerializer(many=True)
